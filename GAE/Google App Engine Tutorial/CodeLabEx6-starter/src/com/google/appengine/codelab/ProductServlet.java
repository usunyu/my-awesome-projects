...
public class ProductServlet extends BaseServlet {
   ...
   */
  public static Key ancestorKey = null;

  static {
    Key key = KeyFactory.createKey("Ancestor", "product");
    if (Util.findEntity(key) == null) {
      Entity ancestor = new Entity(key);
      Util.persistEntity(ancestor);
    }
    ancestorKey = key;
  }
