		...
		if(data.length > 0){
			for (var i=0;i<data.length;i++){
				...
				case ENTITY_ITEM:
					...
					break;
				case ENTITY_ORDER:
					htm+='<td>'+data[i].name+'</td><td>'+data[i].itemName+'</td><td>'+data[i].customerName+'</td><td>'+data[i].shipTo+'</td><td>'+data[i].quantity+'</td><td>'+data[i].price+'</td>';
					break;
				case ENTITY_CUSTOMER:
					htm+='<td>'+data[i].name+'</td><td>'+data[i].firstName+'</td><td>'+data[i].lastName+'</td><td>'+data[i].address+'</td><td>'+data[i].phone+'</td><td>'+data[i].eMail+'</td>';
					break;
				default:
					htm+=""; 
				}
