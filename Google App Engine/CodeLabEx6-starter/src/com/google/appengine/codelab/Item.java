...
public class Item {
  ...
  public static Iterable<Entity> getAllItems() {
  	Iterable<Entity> entities = Util.listEntities("Item", null, null, ProductServlet.ancestorKey);
  	return entities;
  }
  ...
  public static Iterable<Entity> getItem(String itemName) {
  	Iterable<Entity> entities = Util.listEntities("Item", "name", itemName, ProductServlet.ancestorKey);
  	return entities;
  }
  ...
  public static Iterable<Entity> getItemsForProduct(String kind, String productName) {
    Key ancestorKey = KeyFactory.createKey(ProductServlet.ancestorKey, "Product", productName);
