 ...
 * @param ancestorKey 
  ...
  public static void createOrUpdateProduct(String name, String description) {
    Entity product = getProduct(name);
  	if (product == null) {
  	  product = new Entity("Product", name, ProductServlet.ancestorKey);
  ...
  public static Iterable<Entity> getAllProducts(String kind) {
    return Util.listEntities(kind, null, null, ProductServlet.ancestorKey);
  }
  ...
  public static Entity getProduct(String name) {
  	Key key = KeyFactory.createKey(ProductServlet.ancestorKey, "Product",name);
  ...
  public static List<Entity> getItems(String name) {
  	...
  	Key parentKey = KeyFactory.createKey(ProductServlet.ancestorKey, "Product", name);
  ...
  {
	  Key key = KeyFactory.createKey(ProductServlet.ancestorKey, "Product",productKey);	   
